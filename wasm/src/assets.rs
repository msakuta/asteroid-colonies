...
pub(crate) struct Assets {
    ...
    pub img_lithium_ingot: HtmlImageElement,
    ...
    pub img_battery_item: HtmlImageElement,
    pub img_conveyor_item: HtmlImageElement,
    pub img_assembler_component: HtmlImageElement,
...
impl Assets {
    ...
    pub fn new(image_assets: js_sys::Array) -> Result<Self, JsValue> {
        ...
        Ok(Self {
            ...
            img_lithium_ingot: load_texture("lithium_ingot")?,
            img_cilicate: load_texture("cilicate")?,
            img_gear: load_texture("gear")?,
            img_wire: load_texture("wire")?,
            img_circuit: load_texture("circuit")?,
            img_battery_item: load_texture("battery_item")?,
            img_conveyor_item: load_texture("conveyor_item")?,
            img_assembler_component: load_texture("assembler_component")?,
